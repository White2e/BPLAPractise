...
def calc_coords(h_object,
    ...
    direction_drone_radiant = np.radians(direction_drone)

    delta_latitude = (D * np.cos(theta_horizontal_radian + phi_horizontal + direction_drone_radiant)) / R
    latitude_object = latitude_drone + np.degrees(delta_latitude)

    delta_longitude = ((D * np.sin(theta_horizontal_radian + phi_horizontal + direction_drone_radiant)) /
