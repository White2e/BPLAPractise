class MySingleton:
    ...
    # def __init__(self):
    #     if not hasattr(self, 'initialized'):  # Проверяем, был ли экземпляр уже инициализирован
    #         self.initialized = True
    #         # Инициализация единственного экземпляра
    #         print("Создан новый экземпляр MySingleton")
...
# # Дополнительная проверка, чтобы показать, что это действительно один и тот же объект
# print(id(singleton1), id(singleton2))  # Должны быть одинаковыми
